    ...
    <Layout>
      <div className="sm:container sm:mx-auto py-[60px] ">
        <div className="grid grid-rows-3 grid-flow-col gap-4">
          <div class="col-span-2 flex items-center space-x-40">
            <img src="https://placeimg.com/640/480/any" alt="Profile Image" className="w-48 h-48 rounded-full mb-4" />
            <h1 className="text-2xl font-bold mb-2 px-30">User Profile</h1>
          </div>
          ...
          <div class="row-span-2 col-auto">
            ...
            <div>
              <a href="#" class="mt-10 inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">
                Enrolled
              </a>
