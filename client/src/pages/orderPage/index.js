    ...
    <Layout>
      {currentUser ? (
        <div className="container mx-auto">
          <h3 className="mb-28 text-lg font-medium text-gray-900 dark:text-white text-center">
            Худалдаж авах төрлөө сонгох
          </h3>
            ...
            <table class="w-full justify-items-center text-sm text-left text-gray-500 dark:text-gray-400 mb-40">
              ...
              <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  <th
                    scope="row"
                    class="text-xl px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                  >
                    Нийт үнэ
                  </th>
          ...
          <div className="fixed inset-0 flex items-center justify-center">
            <button
              type="button"
              onClick={openModal}
              className="mt-96 rounded-md px-[500px] py-36 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
            ></button>
          </div>
