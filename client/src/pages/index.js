          ...
          <HomeLayout className="pt-0 pb-16 ">
            <div className="block items-center justify-between lg:flex w-full px-32 md:px-32 sm:px-16">
              <div className="lg:w-1/2 flex flex-col items-center self-center md:w-full">
                <AnimatedText text={'Welcome to Kil -A- Bytes team project'} className="!text-left" />
                <p className="my-4 text-base font-medium ">Цахим хичээл болон тэтгэлэгийн мэдээллийн нэгдсэн сан.</p>
              ...
              <div className="lg:w-1/2 h-1/3 md:w-full w-full">
                <Image src={bannerImage} alt="Kil-A-Bytes" className="w-full h-auto" />
              </div>
            </div>
          </HomeLayout>
